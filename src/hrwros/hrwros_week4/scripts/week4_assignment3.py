...
def week4_assignment3():
  ...
  robot2_group = moveit_commander.MoveGroupCommander("robot2")  # Here!!
  ...
  robot2_group.set_named_target("R2Home")  # Here!
  ...
  robot2_client.send_goal(robot2_goal)  # Here!
  robot2_client.wait_for_result()

  ## Move robot2 to R2PreGrasp pose
  robot2_group.set_named_target("R2PreGrasp")  # Here!
  ...
  new_robot2_eef_pose.position.x = current_robot2_pose.pose.position.x - 0.05  # Here!
  # Create a y-offset of +10cm to the current y position.
  new_robot2_eef_pose.position.y = current_robot2_pose.pose.position.y + 0.10  # Here!
  # Create a z-offset of -10cm to the current z position.
  new_robot2_eef_pose.position.z = current_robot2_pose.pose.position.z - 0.10  # Here!
  ...
  waypoints.append(new_robot2_eef_pose)  # Here!
  ...
  waypoints.append(current_robot2_pose.pose)  # Here!
  ...
  robot2_group.set_named_target("R2Place")  # Here!
